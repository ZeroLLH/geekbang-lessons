...
<body>
	<div class="container">
		<form class="form-signin" action="${pageContext.request.contextPath}/hello/loginPost" method="post">
			...
			<button class="btn btn-lg btn-primary btn-block" type="submit">Sign
				in</button>
			<button class="btn btn-lg btn-primary btn-block" type="button"><a href="${pageContext.request.contextPath}/hello/register">Sign
				up</a></button>
